...
public object ScrollGeometry {
     ...
     */
    public fun follow(offset: Int, focusStart: Int, focusEnd: Int, viewportSize: Int, maxOffset: Int, margin: Int = 0): Int {
    ...
    public fun center(focusStart: Int, focusEnd: Int, viewportSize: Int, maxOffset: Int): Int {
        if (maxOffset <= 0) return 0
