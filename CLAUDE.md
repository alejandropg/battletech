...
| `docs/build.md` | Touching `buildSrc/`, a `build.gradle.kts`, module dependencies, or `unit/`/`map/`/`mech/`/`theme/`/shadow-jar packaging. |
...
| `docs/unit-files.md` | Touching `unit/*.json` or unit-collection loading and validation. |
