...
public class HeatBarWidget(
    ...
    public fun draw(canvas: Canvas, x: Int, y: Int, value: Int): Int {
        ...
        canvas.writeString(x, y, "[$bar]$suffix", Cell.Style(color))
        ...
        canvas.writeString(anchorCol - valueStr.length + 1, y + 1, valueStr, Cell.Style(color))
        return y + 2
    }
