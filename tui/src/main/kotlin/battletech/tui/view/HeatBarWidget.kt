...
public class HeatBarWidget(
    ...
    public fun draw(buffer: ScreenBuffer, x: Int, row: Int, value: Int): Int {
        ...
        buffer.writeString(x, row, "[$bar]$suffix", color)
        ...
        buffer.writeString(anchorCol - valueStr.length + 1, row + 1, valueStr, color)
        return row + 2
    }
