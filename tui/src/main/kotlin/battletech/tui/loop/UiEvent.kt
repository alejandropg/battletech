 ...
 * - [AnimationTick]: the elapsed-time weapon-fire overlay should be sampled again. [token]
 *   identifies the currently scheduled wake-up; stale wake-ups are ignored.
...
internal sealed interface UiEvent {
    ...
    data class AnimationTick(val token: Long) : UiEvent
