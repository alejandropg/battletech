...
internal class PanelScrollTest {
    ...
    fun `slotAt returns the matching expanded slot`() {
        val slot = PanelSlotLayout(panelKey = '1', x = 100, width = 28, collapsed = false)
    ...
    fun `slotAt returns null for collapsed slot`() {
        val slot = PanelSlotLayout(panelKey = '1', x = 100, width = 7, collapsed = true)
        val layout = layout(boardWidth = 100, boardHeight = 40, slots = listOf(slot))
    ...
    fun `slotAt returns correct slot from multiple slots`() {
        val slot1 = PanelSlotLayout(panelKey = '1', x = 100, width = 28, collapsed = false)
        val slot2 = PanelSlotLayout(panelKey = '2', x = 128, width = 28, collapsed = false)
