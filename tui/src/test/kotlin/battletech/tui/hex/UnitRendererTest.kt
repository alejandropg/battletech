...
internal class UnitRendererTest {
    ...
    fun `renders unit id at hex center`() {
        ...
        assertEquals(Color.PLAYER_1, buffer.get(4, 3).style.fg)
        assertEquals(Color.PLAYER_1, buffer.get(5, 3).style.fg)
    }
    ...
    fun `renders only the chars present when id is shorter than 2 chars`() {
        ...
        UnitRenderer.render(Canvas.of(buffer), 0, 0, "A", HexDirection.N, Color.PLAYER_1)
    ...
    fun `takes at most 2 chars from a longer id`() {
        ...
        UnitRenderer.render(Canvas.of(buffer), 0, 0, "ABC", HexDirection.N, Color.PLAYER_1)
    ...
    fun `renders destroyed marker left of id when destroyed and id row is not crowded`() {
        ...
        UnitRenderer.render(Canvas.of(buffer), 0, 0, "A1", HexDirection.N, Color.PLAYER_1, isDestroyed = true)

        assertEquals("A", buffer.get(4, 3).char)
        assertEquals("1", buffer.get(5, 3).char)
        assertEquals(ICON_ROBOT_DEAD, buffer.get(3, 3).char)
        assertEquals(Color.PLAYER_1, buffer.get(3, 3).style.fg)
    }
    ...
    fun `renders south facing arrow`() {
        ...
        UnitRenderer.render(Canvas.of(buffer), 0, 0, "A1", HexDirection.S, Color.PLAYER_1)
    ...
    fun `renders northeast facing arrow`() {
        ...
        UnitRenderer.render(Canvas.of(buffer), 0, 0, "A1", HexDirection.NE, Color.PLAYER_1)
    ...
    fun `renders southeast facing arrow`() {
        ...
        UnitRenderer.render(Canvas.of(buffer), 0, 0, "A1", HexDirection.SE, Color.PLAYER_1)
    ...
    fun `renders southwest facing arrow`() {
        ...
        UnitRenderer.render(Canvas.of(buffer), 0, 0, "A1", HexDirection.SW, Color.PLAYER_1)
    ...
    fun `renders northwest facing arrow`() {
        ...
        UnitRenderer.render(Canvas.of(buffer), 0, 0, "A1", HexDirection.NW, Color.PLAYER_1)
    ...
    fun `no torso arrow when torso equals leg facing`() {
        ...
        UnitRenderer.render(Canvas.of(buffer), 0, 0, "A1", HexDirection.N, Color.PLAYER_1, torsoFacing = HexDirection.N)
    ...
    fun `clockwise twist with N legs places torso arrow at NE slot`() {
        ...
        UnitRenderer.render(Canvas.of(buffer), 0, 0, "A1", HexDirection.N, Color.PLAYER_1, torsoFacing = HexDirection.NE)
    ...
    fun `counterclockwise twist with N legs places torso arrow at NW slot`() {
        ...
        UnitRenderer.render(Canvas.of(buffer), 0, 0, "A1", HexDirection.N, Color.PLAYER_1, torsoFacing = HexDirection.NW)
    ...
    fun `clockwise twist with NE legs places torso arrow at SE slot`() {
        ...
        UnitRenderer.render(Canvas.of(buffer), 0, 0, "A1", HexDirection.NE, Color.PLAYER_1, torsoFacing = HexDirection.SE)
    ...
    fun `counterclockwise twist with NE legs places torso arrow at N slot`() {
        ...
        UnitRenderer.render(Canvas.of(buffer), 0, 0, "A1", HexDirection.NE, Color.PLAYER_1, torsoFacing = HexDirection.N)
    ...
    fun `clockwise twist with SE legs places torso arrow at S slot`() {
        ...
        UnitRenderer.render(Canvas.of(buffer), 0, 0, "A1", HexDirection.SE, Color.PLAYER_1, torsoFacing = HexDirection.S)
    ...
    fun `counterclockwise twist with SE legs places torso arrow at NE slot`() {
        ...
        UnitRenderer.render(Canvas.of(buffer), 0, 0, "A1", HexDirection.SE, Color.PLAYER_1, torsoFacing = HexDirection.NE)
    ...
    fun `clockwise twist with S legs places torso arrow at SW slot`() {
        ...
        UnitRenderer.render(Canvas.of(buffer), 0, 0, "A1", HexDirection.S, Color.PLAYER_1, torsoFacing = HexDirection.SW)
    ...
    fun `counterclockwise twist with S legs places torso arrow at SE slot`() {
        ...
        UnitRenderer.render(Canvas.of(buffer), 0, 0, "A1", HexDirection.S, Color.PLAYER_1, torsoFacing = HexDirection.SE)
    ...
    fun `clockwise twist with SW legs places torso arrow at NW slot`() {
        ...
        UnitRenderer.render(Canvas.of(buffer), 0, 0, "A1", HexDirection.SW, Color.PLAYER_1, torsoFacing = HexDirection.NW)
    ...
    fun `counterclockwise twist with SW legs places torso arrow at S slot`() {
        ...
        UnitRenderer.render(Canvas.of(buffer), 0, 0, "A1", HexDirection.SW, Color.PLAYER_1, torsoFacing = HexDirection.S)
    ...
    fun `clockwise twist with NW legs places torso arrow at N slot`() {
        ...
        UnitRenderer.render(Canvas.of(buffer), 0, 0, "A1", HexDirection.NW, Color.PLAYER_1, torsoFacing = HexDirection.N)
    ...
    fun `counterclockwise twist with NW legs places torso arrow at SW slot`() {
        ...
        UnitRenderer.render(Canvas.of(buffer), 0, 0, "A1", HexDirection.NW, Color.PLAYER_1, torsoFacing = HexDirection.SW)
    ...
    fun `destroyed unit with a torso arrow at x+3 in the id row puts the marker in the arrow row`() {
        ...
        UnitRenderer.render(
            Canvas.of(buffer), 0, 0, "A1", HexDirection.NW, Color.PLAYER_1,
    ...
    fun `destroyed unit whose torso arrow lands in the id row at x+5 still relocates the marker`() {
        ...
        UnitRenderer.render(
            Canvas.of(buffer), 0, 0, "A1", HexDirection.NE, Color.PLAYER_1,
