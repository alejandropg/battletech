 ...
 * scroll math in [ScrolledTest] — into what every side panel and the tactical board actually
 * render. These cases exercise the composition itself: specifically, that [Bordered.PADDING]'s
 * top row is folded into the *content stream* (via [Padded]) rather than the viewport, which is
 * what makes it a spacer at rest that the content reclaims the instant the view scrolls.
 */
