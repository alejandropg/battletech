...
internal class AttackResultsViewTest {
    ...
    private fun aHitResult(
        ...
        attempt = ToHitAttempt(
            ...
            toHitRoll = toHitRoll,
            toHit = ToHitBreakdown(ToHitBase.GUNNERY, gunnery, modifiers),
        ),
    ...
    private fun renderToString(results: List<AttackResult>, width: Int = 34, height: Int = 30, viewer: PlayerId = PlayerId.PLAYER_1): String {
        ...
        return renderInPanel(view, badge = '5', title = AttackResultsView.TITLE, width = width, height = height).text()
    }
